...
namespace Cms20LinqOchAnnat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var over30GoalsLinq = players.Where(p => p.Goals > 30);
            ...
            foreach (var p in players.Where(p => p.Name == team).OrderByDescending(p => p.Name))
            {
            ...
            foreach (var playerP in players.Where(p => p.Name.StartsWith("R") && p.Team == team))
            {
